...
public class LdapProfile {
    ...
    public boolean isCertUse() {
    	if(x509truststore != null || trustStore != null)
    		return true;
    	return false;
    }
    ...
    @Deprecated
    public void setTrustStore(CertificateType type, String base64EncodedCert) throws GeneralSecurityException, IOException, ParseException {
    ...
    public String toString() {
        return String.format(
                "%s [target=%s, host=%s:%d, account=%s, type=%s, base dn=%s, sync time=%s, ca=%s]", name,
                targetDomain, dc, getPort(), account, serverType, baseDn, syncTime, x509truststore != null);
    }
