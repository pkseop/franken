...
public class KrakenWebSocketServerHandshaker00 extends WebSocketServerHandshaker {
    ...
    */
   public KrakenWebSocketServerHandshaker00(String webSocketURL, String subprotocols, int maxFramePayloadLength) {
       super(WebSocketVersion.V00, webSocketURL, subprotocols, maxFramePayloadLength);
   }
   
   public KrakenWebSocketServerHandshaker00(String webSocketURL, String subprotocols, int maxFramePayloadLength, String host, Channel channel) {
      super(WebSocketVersion.V00, webSocketURL, subprotocols, maxFramePayloadLength);
      this.host = host;
   ...
   protected FullHttpResponse newHandshakeResponse(FullHttpRequest req, HttpHeaders headers) {
       ...
       if (isHixie76) {
           ...
           input.writeInt(b);
           input.writeLong(c);
           res.content().writeBytes(KrakenWebSocketUtil.md5(input.array()));
       } else {
   ...
   protected WebSocketFrameDecoder newWebsocketDecoder() {
       return new KrakenWebSocket00FrameDecoder(maxFramePayloadLength(), host, channel);
   }
