...
final class KrakenReplayingDecoderBuffer extends ByteBuf{
	 private static final Signal REPLAY = KrakenReplayingDecoder.REPLAY;

    private ByteBuf buffer;
    private boolean terminated;
    private SwappedByteBuf swapped;

    static final KrakenReplayingDecoderBuffer EMPTY_BUFFER = new KrakenReplayingDecoderBuffer(Unpooled.EMPTY_BUFFER);

    static {
        EMPTY_BUFFER.terminate();
    }

    KrakenReplayingDecoderBuffer() { }

    KrakenReplayingDecoderBuffer(ByteBuf buffer) {
