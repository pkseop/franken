...
import kr.co.future.msgbus.MessageHandler;
import kr.co.future.msgbus.MessageListener;
import kr.co.future.msgbus.MsgbusConfig;
...
import kr.co.future.msgbus.SessionEventHandler;
...
public class MessageBusImpl extends ServiceTracker implements MessageBus, Runnable {
	...
	private void reduceStackTrace(InvocationTargetException e) {
		...
		for (StackTraceElement el : t.getStackTrace()) {
			if (el.getClassName().equals("kr.co.future.msgbus.handler.MsgbusPluginHandler")) {
				found = true;
				break;
			}
