require(["/lib/jquery.js",
	...
	Socket.send("kr.co.future.dom.msgbus.AreaPlugin.getRootAreas", {}, function(message) {
		console.log(message)
	...
	$("#btnAddNewArea").on("click", function(e) {
		...
		Socket.send("kr.co.future.dom.msgbus.AreaPlugin.createArea", newarea, function(message) {
			console.log(message)
	...
	$("#btnRemoveArea").on("click", function() {
		...
		Socket.send("kr.co.future.dom.msgbus.AreaPlugin.removeArea", {
