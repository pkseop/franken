 ...
 */
package kr.co.future.core.main;
...
import kr.co.future.api.Environment;
import kr.co.future.api.InstrumentationService;
import kr.co.future.api.LoggerControlService;
...
import kr.co.future.core.account.AccountScriptFactory;
import kr.co.future.core.auth.AuthScriptFactory;
import kr.co.future.core.auth.DefaultAuthService;
import kr.co.future.core.bundle.BundleManagerService;
import kr.co.future.core.bundle.BundleScript;
import kr.co.future.core.bundle.BundleScriptFactory;
import kr.co.future.core.console.TelnetCodecFactory;
import kr.co.future.core.console.TelnetHandler;
import kr.co.future.core.instrumentation.InstrumentationServiceImpl;
import kr.co.future.core.keystore.KeyStoreScriptFactory;
import kr.co.future.core.logger.KrakenLogService;
import kr.co.future.core.logger.LogCleaner;
import kr.co.future.core.logger.LoggerScriptFactory;
import kr.co.future.core.pkg.PackageScriptFactory;
import kr.co.future.core.script.ConfScriptFactory;
import kr.co.future.core.script.CoreScriptFactory;
import kr.co.future.core.script.HistoryScriptFactory;
import kr.co.future.core.script.OsgiScriptFactory;
import kr.co.future.core.script.OutputOnlyScriptContext;
import kr.co.future.core.script.PerfScriptFactory;
import kr.co.future.core.script.SunPerfScriptFactory;
import kr.co.future.core.script.batch.BatchScriptFactory;
import kr.co.future.core.ssh.SshCommandFactory;
import kr.co.future.core.ssh.SshFileSystemFactory;
import kr.co.future.core.ssh.SshPasswordAuthenticator;
import kr.co.future.core.thread.ThreadScriptFactory;
import kr.co.future.cron.CronService;
import kr.co.future.cron.impl.CronScriptFactory;
import kr.co.future.cron.impl.CronServiceImpl;
//import kr.co.future.cron.msgbus.CronPlugin;
...
public class Kraken implements BundleActivator, SignalHandler {
	...
	private String getSystemPackages() throws FileNotFoundException {
        ...
        InputStreamReader is = new InputStreamReader(ClassLoader.getSystemResourceAsStream("system.packages"));
