...
import kr.co.future.auth.api.AuthCallback;
import kr.co.future.auth.api.AuthProvider;
import kr.co.future.auth.api.UserCredentials;
import kr.co.future.auth.api.UserPrincipal;
...
//		if (name.equals("root"))		//pks. 2015-09-04. to make possible to remove any accounts
