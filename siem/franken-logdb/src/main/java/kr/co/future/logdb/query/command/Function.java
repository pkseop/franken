...
import kr.co.future.logdb.query.command.NumberUtil;
import kr.co.future.logdb.query.command.Function.EvaledField.EvalType;
...
public abstract class Function {
	...
	protected static class DistinctCount extends Function {
		...
		@Override
		public Function merge(Function func) {
			DistinctCount c = (DistinctCount) func;
			this.result += c.result;
			return this;
		}
	}
