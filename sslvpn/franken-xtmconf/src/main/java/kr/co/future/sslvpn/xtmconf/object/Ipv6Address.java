...
public class Ipv6Address extends XtmConfig {
	private int num;
	private String cid;
	private String name; // 객체명
	private String desc; // 설명
	private List<String> ip = new ArrayList<String>(); // IPv6 주소

	@Override
	public String getXmlFilename() {
		return "object_ipv6_address.xml";
	}
	...
	public static Ipv6Address parse(NodeWrapper nw) {
	...
	protected Element convertToElement(Document doc) {
		...
		for (String i : ip)
			appendChild(doc, e, "ip", i, new AttributeBuilder("type", Utils.ipType(i)).put("version", "v6"));
	...
	public Map<String, Object> marshal() {
		...
		for (String s : ip)
			l.add(new MarshalValue("value", s).put("version", Utils.ipVersion(s)).put("type", Utils.ipType(s)).get());
		m.put("ip", l);
	...
	public String toString() {
		return "Ipv6Address [num=" + num + ", cid=" + cid + ", name=" + name + ", desc=" + desc + ", ip=" + ip + "]";
	}
}
